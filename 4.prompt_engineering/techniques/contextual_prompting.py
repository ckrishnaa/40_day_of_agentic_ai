"""
contextual_prompting.py
-----------------------
Technique: Contextual Prompting

BEFORE: Asking a specific question without any prior context, relying solely
        on the LLM's pre-trained knowledge.
AFTER:  Injecting specific facts or background context into the prompt 
        before the user's question, ensuring the LLM uses that context 
...
def get_contextual_prompt(question: str = SAMPLE_INPUT, context: str = SAMPLE_CONTEXT, mode: str = "after") -> str:
